...
message(STATUS "camera: 0 messages, 1 services")
...
get_filename_component(_filename "/home/pooh/car_code_ws/src/camera/srv/message.srv" NAME_WE)
add_custom_target(_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera" "/home/pooh/car_code_ws/src/camera/srv/message.srv" ""
)
...
_generate_srv_cpp(camera
  "/home/pooh/car_code_ws/src/camera/srv/message.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/camera)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/camera\")")
  # install generated code
  install(
